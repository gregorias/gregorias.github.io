...
that our formula is just: $$ 1 - \left(H_n - H_{\frac{n}{2}}\right) $$ where
$$H_n $$ is the n'th harmonic number. Therefore:

$$ 1 - \left(H_n - H_{\frac{n}{2}}\right) \approx 1 - \left(\log n - \log \frac{n}{2}\right) = 1 - \log 2 = 0.307 $$
...
### The permutation is not uniformly random
